...
public class DebRepositoryPollerTest {
    ...
    public void shouldGetTheRightLocationForAnyPackage_getLatestRevision() {
        ...
        ppc.add(new Property(Constants.PACKAGE_NAME, "php"));
    ...
    public void shouldThrowExceptionGivenNonExistingPackageInExistingRepo_getLatestRevision() {
        ...
        try {
            ...
            String expectedMessage = String.format("Error while querying repository with path '%s' and package spec '%s'.", repositoryPackageConfigurations.get(Constants.REPO_URL).getValue(), "crap-artifact");
